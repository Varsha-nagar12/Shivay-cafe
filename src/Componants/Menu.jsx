    ...
    return <>
        ...
        <div className="container mx-auto tm-container py-24 sm:py-48">
            ...
            <div className="flex flex-col lg:flex-row justify-around items-center">
                ...
                <div className="flex-1 m-5 rounded-xl px-4 py-6 sm:px-8 sm:py-10 tm-bg-green tm-item-container">
                <div className="flex items-start mb-6 tm-menu-item">
                        ...
                        <div className="ml-3 sm:ml-6">
                            ...
                            <div className="text-white text-md sm:text-lg font-light"> Rs 150</div>
                            {/* <button type="button" class="btn btn-outline-success">Order Now</button> */}
                            </div>                    
                    </div>
                    <div className="flex items-start mb-6 tm-menu-item">
